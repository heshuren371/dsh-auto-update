...
.dsau-btn-primary { background: var(--dsw-alias-brand-primary); color: #fff; }
.dsau-btn-primary:hover:not(:disabled) { opacity: 0.9; background: var(--dsw-alias-brand-primary); }
.dsau-btn-danger { background: var(--dsw-alias-state-error-primary); color: #fff; }
...
`;
    ...
    function describe(state, t) {
      ...
      if (snapshot === null || snapshot === undefined) return { text: t("loading"), tone: "muted" };
